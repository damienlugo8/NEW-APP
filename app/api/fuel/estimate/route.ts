 ...
 *
 * The single-plate estimator behind the "Snap it" camera path of the meal
 * sheet. Looks at ONE plate of food and returns calories/protein/carbs/fat
 * plus a blunt one-line verdict. (The fridge-scan meal *builder* lives at
 * /api/fuel/analyze — different job, different output.)
 *
